...
if ($_SESSION['loggedIn'] == 'true')
{
    ...
    if (filter_var($itemSelected, FILTER_VALIDATE_INT))
    {
        ...
        $SQLquery = "SELECT AvatarItems.id_pk, AvatarItems.type
                     FROM AvatarItems
        ...
        if($itemCheck)
        {
            //Set existing item to unequipped
            $dbConn = getConnection();
            ...
            $stmt->execute(array(':userID' => $_SESSION['userID'], ':type' => $itemCheck->type));
