...
if ($_SESSION['loggedIn'] == 'true')
{
    if ($_SESSION['teacher'] == true)
    {
        ...
        <head>
            <meta charset=\"UTF-8\" />
            <meta name='previousClass' content='{$classSelected}'>
        ...
        echo "Which class would you like to move the students selected to?";
        ...
        <div class='yesNoButtContainer'>
            ...
            <div class='yesButtContainer' onclick='linkToMoveProc()'><a href='#'>Yes</a></div>
        </div><br>
        ";
...
?>
    ...
    <script type="text/javascript">
        ...
        function linkToMoveProc()
        {
            var t = document.getElementsByTagName('meta');
            var previousClass = t[1].getAttribute('content');
            var classSelect = document.getElementById('classSelect2').value;
            const page = "moveStudentProcess.php?classSelected=";
            var textHolder = "&previousClass="
            const holder = page.concat(classSelect,textHolder, previousClass);
